...
class EnterpriseViolationHistoryAdapter(data: MutableList<Int>? = null, val onClickListener: OnClickListener) :
    BaseBindingAdapter<Int, ItemEnterpriseViolationHistoryBinding>(data) {
    override fun convert(holder: VBViewHolder<ItemEnterpriseViolationHistoryBinding>, item: Int) {
