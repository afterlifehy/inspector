...
import com.rt.inspector.databinding.ItemParkingLotBinding
...
class ParkingLotAdapter(data: MutableList<ParkingLotBean>? = null, val onClickListener: OnClickListener) :
    ...
    init {
        ...
        plateBgMap[Constant.OLD_OTHERS] = com.rt.common.R.mipmap.ic_plate_bg_white
        ...
        plateTxtColorMap[Constant.OLD_OTHERS] = com.rt.base.R.color.black
    }
