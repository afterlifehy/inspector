...
public class PickerView extends View {
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, com.rt.base.R.color.color_fff15a24);
        mDarkColor = ContextCompat.getColor(mContext, com.rt.base.R.color.color_ff666666);
    }
